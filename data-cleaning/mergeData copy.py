...
def mergeFilesForUser(uid, write_csv=False):
    ...
    '''
    path_to_data = os.path.join("data_raw_new", "")
    ...
    surveyData = pd.read_csv(path_to_data + "DailySurveys_DATA_2020-01-27_1128.csv") 
    ...
    if write_csv:
        ...
        #both_runs = final_merged.sort_values(by=['ActivityDate'])
